...
<?php if(is_product()){ ?>
    ...
    <ul class="product_breadcrumb">
        <li><a href="<?php echo add_query_arg('category', 'Womens', site_url('/store')); ?>">Womens</a></li>
        <li><a href="<?php echo add_query_arg('category', $category->name, site_url('/store')); ?>"><?= $category->name ?></a></li>
        <li><?= $product->name ?></li>
    </ul>
